...
namespace BackCursos.Controllers
{
    public class CursosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CursoId,Descricao,DataInicial,DataFinal,QtdAlunos,CategoriaId")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CursoId,Descricao,DataInicial,DataFinal,QtdAlunos,CategoriaId")] Curso curso)
        {
            if (id != curso.CursoId)
            {
                return NotFound();
